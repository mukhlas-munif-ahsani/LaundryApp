...
import com.tiunida.laundry0.ActivityOrderDetail.Interactor.OrderDetailInteractor;
import com.tiunida.laundry0.ActivityOrderDetail.Interactor.OrderDetailInteractorMvp;
...
public class OrderDetailPresenter implements OrderDetailPresenterMvp {
    ...
    private OrderDetailViewMvp mDetailOrderViewMvp;
    private EventBus mEventBus;
    String string2 = "0";

    public OrderDetailPresenter(OrderDetailViewMvp orderDetailViewMvp) {
        mDetailOrderViewMvp = orderDetailViewMvp;
    ...
    public void onEventMainThread(OrderDetailEvents event) {
        switch (event.getEventType()) {
            ...
            case OrderDetailEvents.onGetDataError:
                ...
                break;
            case OrderDetailEvents.onUpdateDataSuccess:
                onUpdateSucces(event.getDataAccept(), event.getDataOnProses(), event.getDataDone(), event.getDataPaid(), event.getDataPaidConfirm(), event.getDataDelivered(), event.getDataDeliveredConfirm());
                break;
        }
    }
    ...
    public void onGedDataSuccess(String jenis,
        ...
        if (mDetailOrderViewMvp != null) {
            ...
            mDetailOrderViewMvp.setAskAdminBtnEnable();
        }
    }
    ...
    void onUpdateSucces(String dataAccept, String dataOnProses,
                        String dataDone, String dataPaid, String dataPaidConfirm,
                        String dataDelivered, String dataDeliveredConfirm) {
        if (mDetailOrderViewMvp != null) {
            mDetailOrderViewMvp.hideProgress();
//            mDetailOrderViewMvp.showMessage("succes");
            setPaidButton(dataDone, dataPaid, dataPaidConfirm);
            setDeliverButton(dataPaidConfirm, dataDelivered, dataDeliveredConfirm);
            setIndicator(dataAccept, dataOnProses, dataDone, dataPaid, dataDelivered);
        }
    }
    ...
    public void setInfo(String jenis, String timeNow, String timeDpne, String weight, String price, String priceDiskon, String diskon) {
        if (jenis != null) {
            mDetailOrderViewMvp.setLaundryType(jenis);
        }

        if (timeNow != null) {
            mDetailOrderViewMvp.setTglPesan(timeNow);
        }

        if (timeDpne != null) {
            mDetailOrderViewMvp.setTglSelesai(timeDpne);
        }

        if (weight != null) {
            mDetailOrderViewMvp.setLaundryWeight(weight);
        }
        ...
        if (diskon != null) {
            mDetailOrderViewMvp.setLaundryDiskon(diskon);
        }
        ...
        if (priceDiskon != null) {
            ...
            mDetailOrderViewMvp.setTotalPriceTxt(String.valueOf(totalPrice));
        }
    }
    ...
    public void setHeadCard(String dataBandana, String dataTopi, String dataMasker, String dataKupluk, String dataKrudung, String dataPeci) {
        if (dataBandana.equals(string2)) {
            mDetailOrderViewMvp.setBandanaCardGone();
        } else {
            mDetailOrderViewMvp.setBandanaNumTxt(dataBandana);
        }

        if (dataTopi.equals(string2)) {
            mDetailOrderViewMvp.setTopiCardGone();
        } else {
            mDetailOrderViewMvp.setTopiNumTxt(dataTopi);
        }

        if (dataMasker.equals(string2)) {
            mDetailOrderViewMvp.setMaskerCardGone();
        } else {
            mDetailOrderViewMvp.setMaskerNumTxt(dataMasker);
        }

        if (dataKupluk.equals(string2)) {
            mDetailOrderViewMvp.setKuplukCardGone();
        } else {
            mDetailOrderViewMvp.setKuplukNumTxt(dataKupluk);
        }

        if (dataKrudung.equals(string2)) {
            mDetailOrderViewMvp.setKrudungCardGone();
        } else {
            mDetailOrderViewMvp.setKrudungNumTxt(dataKrudung);
        }

        if (dataPeci.equals(string2)) {
            mDetailOrderViewMvp.setPeciCardGone();
        } else {
            mDetailOrderViewMvp.setPeciNumTxt(dataPeci);
        }
    }
    ...
    public void setBodyCard(String dataKaos, String dataKaosDalam, String dataKemeja, String dataBajuMuslim, String dataJaket, String dataSweter, String dataGamis, String dataHanduk) {
        if (dataKaos.equals(string2)) {
            mDetailOrderViewMvp.setKaosCardGone();
        } else {
            mDetailOrderViewMvp.setKaosNumTxt(dataKaos);
        }

        if (dataKaosDalam.equals(string2)) {
            mDetailOrderViewMvp.setKaosDalamCardGone();
        } else {
            mDetailOrderViewMvp.setKaosDalamNumTxt(dataKaosDalam);
        }

        if (dataKemeja.equals(string2)) {
            mDetailOrderViewMvp.setKemajaCardGone();
        } else {
            mDetailOrderViewMvp.setKemejaNumTxt(dataKemeja);
        }

        if (dataBajuMuslim.equals(string2)) {
            mDetailOrderViewMvp.setBajuMuslimCardGone();
        } else {
            mDetailOrderViewMvp.setBajuMuslimNumTxt(dataBajuMuslim);
        }

        if (dataJaket.equals(string2)) {
            mDetailOrderViewMvp.setJaketCardGone();
        } else {
            mDetailOrderViewMvp.setJaketNumTxt(dataJaket);
        }

        if (dataSweter.equals(string2)) {
            mDetailOrderViewMvp.setSweterCardGone();
        } else {
            mDetailOrderViewMvp.setSweterNumTxt(dataSweter);
        }

        if (dataGamis.equals(string2)) {
            mDetailOrderViewMvp.setGamisCardGone();
        } else {
            mDetailOrderViewMvp.setGamisNumTxt(dataGamis);
        }

        if (dataHanduk.equals(string2)) {
            mDetailOrderViewMvp.setHandukCardGone();
        } else {
            mDetailOrderViewMvp.setHandukNumTxt(dataHanduk);
        }
    }

    public void setHandCard(String dataSarungTangan, String dataSapuTangan) {
        if (dataSarungTangan.equals(string2)) {
            mDetailOrderViewMvp.setSarungTanganCardGone();
        } else {
            mDetailOrderViewMvp.setSarungTanganNumTxt(dataSarungTangan);
        }

        if (dataSapuTangan.equals(string2)) {
            mDetailOrderViewMvp.setSapuTanganCardGone();
        } else {
            mDetailOrderViewMvp.setSapuTanganNumTxt(dataSapuTangan);
        }
    }
    ...
    public void setFeetCard(String dataCelana, String dataCelanaDalam, String dataCelanaPendek, String dataSrung, String dataCelanaOlahraga, String dataRok, String dataCelanaLevis, String dataKaosKaki) {
        if (dataCelana.equals(string2)) {
            mDetailOrderViewMvp.setCelanaCardGone();
        } else {
            mDetailOrderViewMvp.setCelanaNumTxt(dataCelana);
        }

        if (dataCelanaOlahraga.equals(string2)) {
            mDetailOrderViewMvp.setCelanaOlahragaCardGone();
        } else {
            mDetailOrderViewMvp.setCelanaOlahragaNumTxt(dataCelanaOlahraga);
        }

        if (dataCelanaDalam.equals(string2)) {
            mDetailOrderViewMvp.setCelanaDalamCardGone();
        } else {
            mDetailOrderViewMvp.setCelanaDalamNumTxt(dataCelanaDalam);
        }

        if (dataCelanaPendek.equals(string2)) {
            mDetailOrderViewMvp.setCelanaPendekCardGone();
        } else {
            mDetailOrderViewMvp.setCelanaPendekNumTxt(dataCelanaPendek);
        }

        if (dataSrung.equals(string2)) {
            mDetailOrderViewMvp.setSarungCardGone();
        } else {
            mDetailOrderViewMvp.setSarungNumTxt(dataSrung);
        }

        if (dataRok.equals(string2)) {
            mDetailOrderViewMvp.setRokCardGone();
        } else {
            mDetailOrderViewMvp.setRokNumTxt(dataRok);
        }

        if (dataCelanaLevis.equals(string2)) {
            mDetailOrderViewMvp.setCelanaLevisCardGone();
        } else {
            mDetailOrderViewMvp.setCelanaLevisNumTxt(dataCelanaLevis);
        }

        if (dataKaosKaki.equals(string2)) {
            mDetailOrderViewMvp.setKaosKakiCardGone();
        } else {
            mDetailOrderViewMvp.setKaosKakiNumTxt(dataKaosKaki);
        }
    }
    ...
    public void setOtherCard(String dataJasAlmamater, String dataJas, String dataSelimutBesar, String dataSelimutKecil, String dataBagCover, String dataGordengKecil, String dataGordengBesar, String dataSepatu, String dataBantal, String dataTasKecil, String dataTasBesar, String dataSpreiKecil, String dataSpreiBesar) {
        if (dataJasAlmamater.equals(string2)) {
            mDetailOrderViewMvp.setJasAlmamaterCardGone();
        } else {
            mDetailOrderViewMvp.setJasAlmamaterNumTxt(dataJasAlmamater);
        }

        if (dataJas.equals(string2)) {
            mDetailOrderViewMvp.setJasCardGone();
        } else {
            mDetailOrderViewMvp.setJasNumTxt(dataJas);
        }

        if (dataSelimutKecil.equals(string2)) {
            mDetailOrderViewMvp.setSelimutKecilCardGone();
        } else {
            mDetailOrderViewMvp.setSelimutKecilNumTxt(dataSelimutKecil);
        }

        if (dataSelimutBesar.equals(string2)) {
            mDetailOrderViewMvp.setSelimutBesarCardGone();
        } else {
            mDetailOrderViewMvp.setSelimutBesarNumTxt(dataSelimutBesar);
        }

        if (dataBagCover.equals(string2)) {
            mDetailOrderViewMvp.setBagCoverCardGone();
        } else {
            mDetailOrderViewMvp.setBagCoverNumTxt(dataBagCover);
        }

        if (dataGordengKecil.equals(string2)) {
            mDetailOrderViewMvp.setGordengKecilCardGone();
        } else {
            mDetailOrderViewMvp.setGordengKecilNumTxt(dataGordengKecil);
        }

        if (dataGordengBesar.equals(string2)) {
            mDetailOrderViewMvp.setGordengBesarCardGone();
        } else {
            mDetailOrderViewMvp.setGordengBesarNumTxt(dataGordengBesar);
        }

        if (dataSepatu.equals(string2)) {
            mDetailOrderViewMvp.setSepatuCardGone();
        } else {
            mDetailOrderViewMvp.setSepatuNumTxt(dataBagCover);
        }

        if (dataBantal.equals(string2)) {
            mDetailOrderViewMvp.setBantalCardGone();
        } else {
            mDetailOrderViewMvp.setBantalNumTxt(dataBantal);
        }

        if (dataTasKecil.equals(string2)) {
            mDetailOrderViewMvp.setTasKecilCardGone();
        } else {
            mDetailOrderViewMvp.setTaskecilNumTxt(dataBagCover);
        }

        if (dataTasBesar.equals(string2)) {
            mDetailOrderViewMvp.setTasBesarCardGone();
        } else {
            mDetailOrderViewMvp.setTasBesarNumTxt(dataTasBesar);
        }

        if (dataSpreiKecil.equals(string2)) {
            mDetailOrderViewMvp.setSpreiKecilCardGone();
        } else {
            mDetailOrderViewMvp.setSreiKecilNumTxt(dataSpreiKecil);
        }

        if (dataSpreiBesar.equals(string2)) {
            mDetailOrderViewMvp.setSpreiBesarCardGone();
        } else {
            mDetailOrderViewMvp.setSpreiBesarNumTxt(dataSpreiBesar);
        }
    }
    ...
    public void setPaidButton(String dataDone, String dataPaid, String dataPaidConfrim) {
        ...
        if (dataDone.equals(exist) && dataPaid.equals(empty) && dataPaidConfrim.equals(empty)) {
            mDetailOrderViewMvp.setPaidBtnEnable();
            ...
            mDetailOrderViewMvp.setPaidBtnDisable();
            mDetailOrderViewMvp.setConfirmPaidBtnTxt("KONFIRMASI TELAH DIBAYAR");
            ...
            mDetailOrderViewMvp.setPaidBtnDisable();
            mDetailOrderViewMvp.setConfirmPaidBtnTxt("MENUNGGU KONFIRMASI KURIR");
        }
    }
    ...
    public void setDeliverButton(String dataPaidConfrim, String delivered, String deliverConfirm) {
        ...
        if (dataPaidConfrim.equals(exist) && delivered.equals(empty) && deliverConfirm.equals(empty)) {
            mDetailOrderViewMvp.setDeliverBtnDisable();
            mDetailOrderViewMvp.setConfirmDeliverBtnTxt("KONFIRMASI TELAH DITERIMA");
            ...
            mDetailOrderViewMvp.setDeliverBtnEnable();
            mDetailOrderViewMvp.setConfirmDeliverBtnTxt("KONFIRMASI TELAH DITERIMA");
        }
    }
